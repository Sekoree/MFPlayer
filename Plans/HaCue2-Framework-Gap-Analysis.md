...
| Control | Single external-input gate | **ABSENT — HaCue2 UX, do NOT retrofit** (collapses HaPlay's two live operator toggles into one and drops edit-mode gating; belongs in the new app) | §5.3 |
