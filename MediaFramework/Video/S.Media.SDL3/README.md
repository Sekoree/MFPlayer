...
- `SDL3VideoEndpoint` — hardware-timed `IVideoEndpoint` + `IClockCapableEndpoint` that
...
- `SDL3VideoCloneEndpoint` — lightweight `IVideoEndpoint` that opens a secondary SDL3
