    ...
    int? VideoStreamIndex = null)
{
    ...
    /// their first frame, which arrives after the clock is built, so they keep
    /// <see cref="MediaClock.DefaultVideoTickInterval"/>.
    /// </para>
    /// </remarks>
    public double VideoTickOversample { get; init; }
