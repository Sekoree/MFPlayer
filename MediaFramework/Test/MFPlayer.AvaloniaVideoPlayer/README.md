...
```bash
dotnet run --project /home/sekoree/RiderProjects/MFPlayer/MediaFramework/Test/MFPlayer.AvaloniaVideoPlayer/MFPlayer.AvaloniaVideoPlayer.csproj -- "/path/to/video.mp4"
```
